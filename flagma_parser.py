...
class FlagmaParser:
    # Класс FlagmaParser инкапсулирует всю логику работы парсера.
    # Klasa FlagmaParser zawiera całą logikę działania parsera.
    def __init__(self):
        # Конструктор класса.
        # Вызывается автоматически при создании объекта.
        # Konstruktor klasy.
        # Wywoływany automatycznie podczas tworzenia obiektu.
